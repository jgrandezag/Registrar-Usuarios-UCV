...
<body background="imagenes/yata.jpg">
...
<Center><a style="font-family:verdana;background-color:black;color:white;" href="cerrarseccion.php">Cerrar Sesion</a></Center>
...
var reg = /^[A-Z0-9._%+-]+@([A-Z0-9-]+.)+[A-Z]{2,4}$/i;
    ...
    if(nombre.trim() == '' ){
        alert('Please enter your nombre.');
        $('#nombre').focus();
        return false;
    }else if(email.trim() == '' ){
        ...
        alert('Please sigue el formato ideal para  email.');
        $('#inputEmail').focus();
        return false;
    }else if(apellido.trim() == '' ){
        alert('Please ingresa tu  Apellido.');
        $('#Apellido').focus();
        return false;
    }else if(telefono.trim() == '' ){
        alert('Please ingresa tu Contraseña.');
        $('#Apellido').focus();
        return false;
    }else{
